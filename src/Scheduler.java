...
public class Scheduler {
    ...
    public void schedule() {
        ...
        ProcessControlBlock pcb1 = new ProcessControlBlock(1, 0, 14, State.READY, 0);

        ArrayList<String[]> arr2 = interpreter.readProgram("src/programs/Program_2.txt");
        ProcessControlBlock pcb2 = new ProcessControlBlock(2, 0, 14, State.READY, 0);

        ArrayList<String[]> arr3 = interpreter.readProgram("src/programs/Program_3.txt");
        ProcessControlBlock pcb3 = new ProcessControlBlock(3, 0, 14, State.READY, 0);
